...
1. `# Persona: [Full Name]`
2. `## Who He/She Is` — biography focused on what causally explains their beliefs
3. `## How He/She Sees Themselves` — when public image diverges from self-conception (omit if no meaningful gap)
4. `## Core Beliefs About Software Development` — each belief bolded, with reasoning
5. `## What He/She Tends to Praise` — bulleted list
6. `## What He/She Tends to Criticize` — bulleted list
...
Include biographical details that explain *why* the person holds their positions. Omit details that don't connect to a downstream belief or communication style. The "Who He/She Is" section should make the rest of the file make sense.
